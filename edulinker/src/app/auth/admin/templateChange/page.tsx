  ...
  return (
    <div
      ...
      className={`
        ...
        ${
          selected
            ? "border-[#E60076] shadow-lg shadow-[#E60076]/20 scale-[1.02]"
            : "border-transparent hover:border-[#E60076]/70"
        }
    ...
    >
      ...
      <div
        className={`
          ...
          ${selected ? "bg-[#E60076]/20" : "group-hover:bg-[#E60076]/5"}
      ...
      {template.pro && (
        <div
          className={`
            ...
            bg-gradient-to-r from-[#E60076] to-[#B3006A]
      ...
      {selected && (
        <div className="absolute top-3 left-3 z-20">
          <div className="bg-[#E60076] text-white text-xs font-bold px-3 py-1 rounded-full flex items-center shadow-lg">
      ...
      <div
        ...
        `}
      >
        <h3 className="font-medium text-lg truncate capitalize">
          {template.nome}
        </h3>
        {template.categoria && (
  ...
  >
    <div className="max-w-6xl mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="flex items-center space-x-3">
        <div className="hidden md:block p-2 rounded-lg bg-[#E60076]/10">
          <Palette className="w-5 h-5 text-[#E60076]" />
        </div>
        <div>
        ...
        className={`
          ...
          ${
            loading || !selectedTemplate || (selectedTemplate.pro && !isPremium)
              ...
              : "bg-gradient-to-r from-[#E60076] to-[#B3006A] hover:from-[#B3006A] hover:to-[#8B005B]"
          }
        `}
      >
        <span
        ...
        >
          ...
          {selectedTemplate?.pro && !isPremium
            ? "Atualize para PRO"
            : "Aplicar Tema"}
        </span>
        ...
        {!loading &&
          selectedTemplate &&
          (!selectedTemplate.pro || isPremium) && (
            <div className="absolute inset-0 z-0 opacity-20 bg-[length:400%_400%] animate-gradient-shift bg-gradient-to-r from-[#E60076] via-[#D3376F] to-[#B3006A]" />
          )}
      </button>
    </div>
  </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        ...
        <div className="text-center mb-12 pt-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-3">
            <span className="bg-gradient-to-r from-[#E60076] to-[#B3006A] bg-clip-text text-transparent">
              Escolha seu Tema
            </span>
          </h1>
