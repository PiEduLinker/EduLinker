    ...
    return (
      <AdminLayout>
        <div className="max-w-2xl mx-auto p-6 text-center">
          <div className="bg-gradient-to-r from-[#E60076] to-[#9f005d] text-white rounded-xl p-8 shadow-lg">
            ...
            <p className="text-[#f4c0db] text-lg mb-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 text-left max-w-md mx-auto">
              ...
              <ul className="space-y-2 text-[#f9e6f0]">
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto p-6 space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-[#E60076] to-[#9f005d] bg-clip-text text-transparent mb-2">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          <div className="bg-gradient-to-r from-[#E60076] to-[#9f005d] p-4 text-white">
            ...
            <div className="flex items-end gap-2 mt-2">
              ...
              <span className="text-[#f4c0db] mb-1">/mês</span>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            {success ? (
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-gradient-to-r from-[#E60076] to-[#9f005d] hover:from-[#d6006e] hover:to-[#7a0043] text-white font-semibold py-4 rounded-xl transition-all disabled:opacity-80 cursor-pointer flex items-center justify-center gap-2 shadow-lg hover:shadow-pink-300"
              >
                {loading ? (
                  <>
                    <svg
