...
const AccountStatusCard = ({ account }: AccountStatusCardProps) => (
  <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-6">
    <div className="flex items-center space-x-3">
      <div className="p-2 rounded-lg bg-[#ffe6f0]">
        <User className="w-5 h-5 stroke-[#f5428d]" />
      </div>
...
export default function AccountSettingsPage() {
  ...
  const handleDelete = async () => {
    if (
      !confirm(
        "⚠️ Tem certeza? Isso excluirá sua conta e todo o site permanentemente."
      )
    ) {
      return;
    }
        ...
        <div className="space-y-8">
          <header className="space-y-2">
            ...
            <p className="text-gray-600">
              Gerencie as informações e configurações da sua conta
            </p>
          </header>
          ...
          <div className="border border-red-100 bg-red-50 rounded-xl p-6 space-y-4">
            ...
            <p className="text-sm text-gray-600">
              ...
              permanentemente removidos do nosso servidor. Esta operação não
              pode ser desfeita.
            </p>
            ...
            <button
              ...
              disabled={loading}
              className={`w-full md:w-auto flex justify-center items-center px-6 py-3 rounded-lg text-white font-medium transition-colors duration-200 cursor-pointer ${
                loading
