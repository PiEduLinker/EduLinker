...
export default function ProfessorCardPremium({
  ...
  return (
    <div className="group relative">
      ...
      {/* Card principal */}
      <div className="relative h-full bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 flex flex-col items-center text-center">
        {/* Foto do professor */}
