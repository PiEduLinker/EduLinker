    ...
    <div className="group relative h-full w-full">
      ...
      <div className="relative h-full bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col">
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <h3 
            className="text-lg font-bold text-gray-900 dark:text-white mb-2 group-hover:text-pink-500 transition-colors duration-300"
            style={{
              display: '-webkit-box',
              WebkitLineClamp: 2,
          ...
          <div 
            className="text-gray-600 dark:text-gray-300 mb-3 flex-grow text-sm"
            style={{
              display: '-webkit-box',
              WebkitLineClamp: 3,
              WebkitBoxOrient: 'vertical',
          ...
          <div className="flex justify-between items-center mt-auto pt-2">
            ...
            <a 
              ...
              className="flex items-center text-pink-500 hover:text-pink-600 dark:hover:text-pink-400 font-medium text-xs transition-colors duration-300"
