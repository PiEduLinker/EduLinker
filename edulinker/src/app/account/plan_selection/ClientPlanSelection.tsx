...
export default function ClientPlanSelection({ siteId, initialStatus }: Props) {
  ...
  const isDisabled = isSubmitting || !selectedPlan;

  return (
    <form
      onSubmit={handleSubmit}
      className="w-full max-w-4xl flex flex-col items-center pb-12 px-4"
    >
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Gratuito */}
        <label
          className={`border rounded-lg p-6 cursor-pointer transition-all bg-white ${
            selectedPlan === "gratuito"
              ? "border-[#E60076] ring-2 ring-pink-200"
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-3">
            <BadgeCheck className="text-[#E60076]" size={20} />
        ...
        {/* Premium */}
        <label
          className={`border rounded-lg p-6 cursor-pointer transition-all bg-white relative ${
            selectedPlan === "premium"
              ? "border-[#E60076] ring-2 ring-pink-200"
              : "border-gray-200 hover:border-[#E60076]"
          }`}
        >
          <div className="absolute top-0 right-0 -mt-3 -mr-1">
            <div className="bg-[#E60076] text-white text-xs font-medium px-3 py-1 rounded-full flex items-center">
          ...
          <div className="flex items-center gap-3 mb-3">
            <ShieldCheck className="text-[#E60076]" size={20} />
            <h2 className="font-semibold text-lg text-[#E60076]">Premium</h2>
          </div>

          <p className="text-gray-700 text-sm mb-4">
            Recursos completos para melhores resultados
          </p>
          ...
          <div className="mt-4 pt-3 border-t border-gray-100 flex justify-between items-center">
            <span className="text-[#E60076] font-bold">R$ 29/mês</span>
      ...
      <button
        type="submit"
        disabled={isDisabled}
        className={`w-full max-w-md mt-8 font-medium py-3 rounded-lg transition-all 
    ${
      isDisabled
        ? "bg-[#E60076] text-white cursor-not-allowed"
        : "bg-[#E60076] text-white hover:bg-pink-700"
    }
  `}
      >
        {isSubmitting ? (
