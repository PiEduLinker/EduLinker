...
export default function CheckList() {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      description: 'Escreva um texto que conte a história da sua escola e o que a torna especial.',
      path: '/auth/admin/about',
      isDone: cfg => !!cfg.descricao,
    },
    {
      title: 'Crie sua galeria de fotos',
      description: 'Adicione fotos da sua escola, professores e alunos para mostrar o ambiente.',
    ...
    },
    {
      ...
      isDone: cfg => Array.isArray(cfg.professores) && cfg.professores.length > 0,
    },
    {
      ...
      isDone: cfg => Array.isArray(cfg.depoimentos) && cfg.depoimentos.length > 0,
    },
    {
